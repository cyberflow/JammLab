...
enum AppTheme {
    ...
    enum ControlSize {
        ...
        static let notationActionButtonWidth: CGFloat = 32
        static let notationActionButtonHeight: CGFloat = controlHeight
        static let notationCompactMenuButtonWidth: CGFloat = notationActionButtonWidth
        ...
        static let notationCompactMenuButtonHeight: CGFloat = notationActionButtonHeight
        static let notationCompactMenuItemSpacing: CGFloat = AppTheme.Spacing.xxxs
        static let notationCompactMenuPadding: CGFloat = AppTheme.Spacing.xxxs
        static let notationDurationGlyphSize: CGFloat = 20
        static let notationAccidentalGlyphSize: CGFloat = 22
    ...
    enum Timeline {
        ...
        static let notationInlineAccidentalGlyphSize: CGFloat = 22
        static let notationInlineAccidentalNoteOffset: CGFloat = 9
        static let notationInlineAccidentalColumnSpacing: CGFloat = 7
        static let notationInlineAccidentalMinimumStaffPositionDistance = 3
