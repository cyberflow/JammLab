...
extension ContentView {
    ...
    func timelineViewState(notationTrackContentWidth: CGFloat) -> TimelineViewState {
        ...
        return TimelineViewState(
            ...
            tieCommandStatus: viewModel.tieCommandStatus,
            ...
            hasPendingStemTranscriptionOverwrite: viewModel.pendingStemTranscriptionOverwrite != nil
        )
    }
    ...
    var timelineViewActions: TimelineViewActions {
        TimelineViewActions(
            ...
            notationAccidentalSelected: { viewModel.handleNotationAccidentalCommand($0) },
            ...
            addTiedNotationNote: { viewModel.handleAddTiedNotationNoteCommand() },
    ...
    var stemTrackActions: StemTrackActions {
        StemTrackActions(
            ...
            transcribe: { viewModel.transcribeStem($0) },
